...
(function (global) {
  ...
  var STR = {
    zh: {
      ...
      resetGame: '重置游戏', resetTitle: '重置游戏数据',
      resetWhat: '选择要清空的内容。清空后无法恢复。',
      resetCareer: '生涯档案与历史记录',
      resetCareerD: '总场数、和牌/负局/荒牌局数、点炮与自摸次数、累计得分、最佳和牌、已达成番种、最近对局记录',
      resetSave: '未完成的对局存档',
      resetSaveD: '删除后「继续游戏」将不可用，只能开新局',
      resetCurrent: '当前：{hands} 局记录 · {matches} 场 · {patterns} 个番种',
      resetHasSave: '有一份未打完的存档（第 {n} 局）', resetNoSave: '没有未完成的对局',
      resetPick: '请至少选择一项', resetConfirmBtn: '确认清空', resetDone: '已清空',
      shortFan: '差 {n} 番', canWinBut: '这张能和牌，但番数不够',
      waitFanLine: '听', fanShort: '不够',
    ...
    en: {
      ...
      resetGame: 'Reset data', resetTitle: 'Reset game data',
      resetWhat: 'Choose what to erase. This cannot be undone.',
      resetCareer: 'Career and history',
      resetCareerD: 'Matches, hands won/lost/drawn, deal-ins, self-draws, net points, best win, patterns achieved, recent hands',
      resetSave: 'Unfinished match',
      resetSaveD: 'Removes the saved match, so Continue will no longer be available',
      resetCurrent: 'Currently: {hands} hands · {matches} matches · {patterns} patterns',
      resetHasSave: 'One unfinished match saved (hand {n})', resetNoSave: 'No unfinished match',
      resetPick: 'Pick at least one', resetConfirmBtn: 'Erase', resetDone: 'Cleared',
      shortFan: '{n} fan short', canWinBut: 'This tile completes your hand, but it is below the minimum',
      waitFanLine: 'Waiting on', fanShort: 'short',
